    ...
    private static String[] loadDefaultEnv() {
        try (BufferedReader reader = new BufferedReader(
            ...
            return new String[] {
                    ...
                    "COM_PICOEDGE_AI_TOOLS_LOGGER_WS_URL=ws://localhost:1065", // Updated to match .env and server
                    "COM_PICOEDGE_AI_TOOLS_LOGGER_USE_LOCAL_SERVER=false" // Updated to align with .env
            };
        }
    }
